...
import P2P4_SCREEN_ONE from './p2p4ScreenOne';
import P2P4_SCREEN_TWO from './p2p4ScreenTwo';
// import SCREEN_TWO from './screenTwo';
// import SCREEN_THREE from "./screenThree";
// import SCREEN_FOUR from "./screenFour";

export default class P2p4ProposalBudgetService {
    screens = [
        SCREEN_ZERO,
        P2P4_SCREEN_ONE,
        P2P4_SCREEN_TWO
    ...
    progressIndicatorSteps = [
        ...
        {
            label: 'Innovation Fund Budget',
            step: 1,
            name: 'P2P4_SCREEN_ONE',
            hidden: false,
            showNext: false,
            showBack: false,
            showDraft: true,
    ...
    /*comboboxvalues =  ['Project_Lead_1_Specialty__c', 'Project_Lead_2_Specialty__c',
        ...
        'Funding_Commitment_Status_5__c'
    ];*/
        ...
        if (event.target.name === 'Token') {
            ...
            if (tokendata) {
                ...
                fetchRecordDetails({ filter: filter, context: this.parent.context }).then(res => {
                    ...
                    // this.parent.data[0].Demo_Rich_Text__c = res.attachments.Demo_Rich_Text__c ? `<p><img src="${res.attachments.Demo_Rich_Text__c}"/></p>` : '';
                    // this.parent.imageData = res.attachments.Demo_Rich_Text__c ? `<p><img src="${res.attachments.Demo_Rich_Text__c}"/></p>` : '';
                    // this.parent.data[0].Demo_Rich_Text_2__c = res.attachments.Demo_Rich_Text_2__c ? `<p><img src="${res.attachments.Demo_Rich_Text_2__c}"/></p>` : '';
                    // this.parent.imageDataTwo = res.attachments.Demo_Rich_Text_2__c ? `<p><img src="${res.attachments.Demo_Rich_Text_2__c}"/></p>` : '';
