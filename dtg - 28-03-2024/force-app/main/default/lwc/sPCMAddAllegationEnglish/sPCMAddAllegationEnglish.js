...
import { OMNIDEF } from './sPCMAddAllegationEnglish_def.js';
import tmpl from './sPCMAddAllegationEnglish.html';
import tmpl_nds from './sPCMAddAllegationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sPCMAddAllegationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
