...
import { OMNIDEF } from './contractTerminateMultiLanguage_def.js';
import tmpl from './contractTerminateMultiLanguage.html';
import tmpl_nds from './contractTerminateMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contractTerminateMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
