...
import { OMNIDEF } from './sPCMAddComplaintParticipantsEnglish_def.js';
import tmpl from './sPCMAddComplaintParticipantsEnglish.html';
import tmpl_nds from './sPCMAddComplaintParticipantsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sPCMAddComplaintParticipantsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
