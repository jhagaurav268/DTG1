...
import { OMNIDEF } from './sampleTypeSampleAssessmentEnglish_def.js';
import tmpl from './sampleTypeSampleAssessmentEnglish.html';
import tmpl_nds from './sampleTypeSampleAssessmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleTypeSampleAssessmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
