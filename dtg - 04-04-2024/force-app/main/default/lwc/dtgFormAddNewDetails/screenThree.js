...
const SCREEN_THREE = {
    "elements": [
        ...
        }, 
        {
            "section": {
                "id": ++counter,
                "heading": { "label": `3.1 Please describe the proposed project using non-technical language emphasizing the research question and its importance to health care delivery. If you receive the award, this summary description will be posted on the IFPOC public website and will be included in press releases. Ensure that your description can be understood outside your research field.`, "showHeading": true, "class": "table-main-heading" },
                "class": "",
                "hidden": false,
                "rows": [
                    {
        ...
        },
        {
            "section": {
                "id": ++counter,
                "heading": { "label": `3.2 What is the innovation and main question or hypothesis for this proposal?`, "showHeading": true, "class": "table-main-heading" },
                "class": "",
                "hidden": false,
                "rows": [
                    {
        ...
        },
        {
            "section": {
                "id": ++counter,
                "heading": { "label": `3.3 Please describe how this project will influence the healthcare system or influence patient care?`, "showHeading": true, "class": "table-main-heading" },
                "class": "",
                "hidden": false,
                "rows": [
                    {
        ...
        },
        {
            "section": {
                "id": ++counter,
                "heading": { "label": `3.4 Please describe your knowledge translation plan for the results of this project (how will you share/disseminate your results and/or spread your innovation)?`, "showHeading": true, "class": "table-main-heading" },
                "class": "",
                "hidden": false,
                "rows": [
                    {
