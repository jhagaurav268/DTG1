...
import { OMNIDEF } from './sampleAssessmentTypeSampleAssessmentSubTypeEnglish_def.js';
import tmpl from './sampleAssessmentTypeSampleAssessmentSubTypeEnglish.html';
import tmpl_nds from './sampleAssessmentTypeSampleAssessmentSubTypeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleAssessmentTypeSampleAssessmentSubTypeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
