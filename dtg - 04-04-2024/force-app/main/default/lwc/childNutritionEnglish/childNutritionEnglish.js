...
import { OMNIDEF } from './childNutritionEnglish_def.js';
import tmpl from './childNutritionEnglish.html';
import tmpl_nds from './childNutritionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class childNutritionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
