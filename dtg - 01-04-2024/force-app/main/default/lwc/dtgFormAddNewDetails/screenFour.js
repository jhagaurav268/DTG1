...
const SCREEN_FOUR = {
    "elements": [
        ...
        },
        {
            "section": {
                "id": ++counter,
                "heading": { "label": `If YES – please elaborate on who will own the patent or title, and explain how potential for conflict of interest will be mitigated. – maximum 1000 characters including spaces`, "showHeading": true, "class": "table-main-heading" },
                "class": "",
                "hidden": false,
                "rows": [
                    {
        ...
        },
        {
            "section": {
                "id": ++counter,
                "heading": { "label": `If YES – please elaborate on how potential for conflict of interest within the project will be mitigated. Maximum 1000 characters including spaces`, "showHeading": true, "class": "table-main-heading" },
                "class": "",
                "hidden": false,
                "rows": [
                    {
        ...
        },
        {
            "section": {
                "id": ++counter,
                "heading": { "label": `Will this project receive funding from any other source than the IF? – including cash or in-kind contributions?`, "showHeading": true, "class": "table-main-heading" },
                "class": "",
                "hidden": false,
                "rows": [
                    {
